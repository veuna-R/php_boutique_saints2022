<?php
    ...
    if($_GET && isset($_GET["categorie"])) {
        ...
        while($produit = $r->fetch(PDO::FETCH_ASSOC)) {
            ...
            $content .= "<div class='col-md-6 col-lg-3 col-sm-12 pb-2 mx-auto'> <div class='card col-12 border border-warning mx-auto bg-transparent shadow' style='max-width: 20rem;'>
